...
//   BookOpen, HelpCircle, Bell, LogOut,
...
//   { to: '/teacher/marks',            icon: BarChart2,       label: 'Add Marks'            },
//   { to: '/teacher/assignments',      icon: FileText,        label: 'Assignments'          },
//   { to: '/teacher/doubts',           icon: HelpCircle,      label: 'Doubts'               },
//   { to: '/teacher/announcements',    icon: Bell,            label: 'Announcements'        },
//   { to: '/teacher/notes',            icon: BookOpen,        label: 'Upload Notes'         },
// ];
    ...
    <div className="flex flex-col h-full">
      <div className="p-5 border-b border-white/10 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-display font-black text-sm text-white leading-none">Teacher Panel</p>
      ...
      <div className="mx-4 mt-4">
        <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-green-900/20 border border-green-700/30">
          <span className="text-green-400 text-xs">👨‍🏫</span>
          <span className="text-xs font-bold uppercase tracking-widest text-green-400">Teacher</span>
        </div>
      </div>
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-[#04060f] border-b border-white/10 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-black text-sm text-white">Teacher Panel</span>
        </div>
